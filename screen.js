...
function preload()
{
	cane_img0 = loadImage("candycane(1).png");
	cane_img1 = loadImage("candycane(1).png");  

	startpage_img = loadImage("startup.jpg");
	wonderland_title = loadImage("winterwonderland.png");
	losescreen1 = loadImage("fire-mountains-copy.jpg")
	losescreen2 = loadImage("Laughing_Snowman-icon.png")
	winscreen1 = loadImage("christmas-village-wallpaper(1).jpg");
   winscreen2 = loadImage("coolSanta.png");
   intermed = loadImage("startup.jpg")
   shift_image = loadImage("computer_key_Shift.png");
   leftarrow_image = loadImage("computer_key_Arrow_Right.png");
   rightarrow_image = loadImage("computer_key_Arrow_Left.png");
